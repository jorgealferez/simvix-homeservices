...
async function main() {
  ...
  await prisma.regulationTemplate.upsert({
    ...
    create: {
      ...
      scope: 'nacional',
      obraTypes: 'OBRA_NUEVA,REFORMA_INTEGRAL,REFORMA_INTERIOR,DEMOLICION,AMPLIACION,REHABILITACION',
  ...
  await prisma.regulationTemplate.upsert({
    ...
    create: {
      ...
      scope: 'nacional',
      obraTypes: 'OBRA_NUEVA,REFORMA_INTEGRAL,REFORMA_INTERIOR,DEMOLICION,AMPLIACION,REHABILITACION,CAMBIO_USO,LEGALIZACION',
  ...
  console.log('✔ RegulationTemplates sembradas.');
}
